 ...
 * @author gustavo
 */
public class CompraDetalleTableModel extends AbstractTableModel{

    /**
     * Objeto Lista que almacena los Detalles de Compra a mostrar en
     * la tabla
     */
    private List<DetallesCompras> datos = new ArrayList<DetallesCompras>();

    /**
     * Retorna la lista que almacena los detalles de compra
     */
    public List<DetallesCompras> getDatos() {
        return datos;
    }
     ...
     */
    public void setDatos(List<DetallesCompras> datos) {
        this.datos = datos;
    ...
    public Object getValueAt(int fila, int columna) {
        ...
        DetallesCompras vd = datos.get(fila);
     ...
     */
    public void agregarDetalle(DetallesCompras vd) {
        if (datos == null) {
            datos = new ArrayList<DetallesCompras>();
        }
        datos.add(vd);
     ...
     * removida en el modelo.
     */
    public void removerDetalle(DetallesCompras vd) {
     ...
     */
    public void actualizarDetalle(int fila, DetallesCompras vd) {
        if (fila < 0 || fila > datos.size()) {
            throw new IndexOutOfBoundsException("No existe la fila " + fila);
        }
        datos.remove(fila);
